...
class PermanentOptions(object):
    ...
    def set_light_wakeup_sensitivity(self):
        """
        sets wakeup sensitivity to 'light'
        """
        self.bitflags &= (~ BIT7)
        self.bitflags |= BIT6
    ...
    def set_heavy_wakeup_sensitivity(self):
        """
        sets wakeup sensitivity to 'heavy'
        """
        self.bitflags &= (~ BIT6)
        self.bitflags |= BIT7
    ...
    def vector_drive(self):
        """
        Set to enable when Sphero  is stopped and ais given a new roll command
    ...
    def demo_mode(self):
        """
        set to enable demo retail mode,
        ball runs a slow rainbow for 60 minutes when palced in charger
        """
    ...
    def enable_gyro_max_async_msg(self):
        ...
        """
        return bool(self.bitflags & BIT8)
